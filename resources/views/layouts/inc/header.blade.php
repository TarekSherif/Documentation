...
<head>
    ...
    <link rel="stylesheet" href="{{url('/')}}/Template/AdminLTE/dist/css/RTL/rtl.css"> @else
    <link rel="stylesheet" href="{{url('/')}}/Template/AdminLTE/dist/css/AdminLTE.min.css"> @endif


    <link rel="stylesheet" href="{{url('/')}}/Template/AdminLTE/dist/css/skins/_all-skins.min.css"> @if($jtable)
    ...
    <link href="{{asset('css/animate.min.css')}}" rel="stylesheet" /> @endif


    <link href="{{asset('css/themes/metroblue/jquery-ui.css')}}" rel="stylesheet" type="text/css" />

    <link rel="stylesheet" href="{{url('/')}}/css/main.css?v=1"> @yield('CSSContent')
