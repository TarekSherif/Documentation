...
('DocumentINReport/1', 'Reports.DocumentINReport', 'fa fa-print sidebar-nav-icon', ' تقرير  دخول استعلام', 'Reports', 1),
('DocumentINReport/2', 'Reports.DocumentINReport', 'fa fa-print sidebar-nav-icon', ' تقرير  دخول خارجية', 'Reports', 2),
('CompanyReport/3', 'Reports.CompanyReport', 'fa fa-print sidebar-nav-icon', ' تقرير  دخول ملحقية', 'Reports', 3),
('CompanyReport/4', 'Reports.CompanyReport', 'fa fa-print sidebar-nav-icon', ' تقرير  دخول القنصلية', 'Reports', 4),
...
( 1, 'DocumentINReport/1', 1, 1, 1, 1, 1, 1),
( 1, 'DocumentINReport/2', 1, 1, 1, 1, 1, 1),
...
( 2, 'DocumentINReport/1', 1, 1, 1, 1, 1, 1),
( 2, 'DocumentINReport/2', 1, 1, 1, 1, 1, 1),
