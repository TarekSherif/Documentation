  ...
  public function CreateBranch()
  {
    ...
    $jTableResult =  array();
            try
            {
                    ...
                    $SQL="INSERT INTO  `Branch` (`BName`, `Baddress`, `BFB`, `BWhats`, `BMail`, `BWebSite`, `BPhones`,`BFax` ,`SOrder`) VALUES ('" . $_POST["BName"] . "', '" . $_POST["Baddress"] . "', '" . $_POST["BFB"] . "', '" . $_POST["BWhats"] . "', '" . $_POST["BMail"] . "', '" . $_POST["BWebSite"] . "', '" . $_POST["BPhones"] . "', '" . $_POST["BFax"] . "','" . $_POST["SOrder"] . "')";
